        ...
        children: [
          ...
          Expanded(
            child: Padding(
              ...
              child: Consumer<BookRideProvider>(builder: (context, value, child) {
                                ...
                                child: ElevatedButton(
                                    style: ButtonStyle(
                                        ...
                                        WidgetStateProperty.all<Color>(
                                            AppColors.primary)),
                                    onPressed: ()async  {
                                      await context.read<BookRideProvider>().selectCoupon(id: promo?.id.toString() ?? '');
                                      Clipboard.setData(ClipboardData(text: promo?.promoCode ?? ''));
                                      showSnackBar(context: context,
                                          message: AppLocalizations.of(context)!.promoApplied,
                                          isSuccess: true);
          ...
          //             return;
          //           }
          //          await context.read<BookRideProvider>().applyPromoCode(context: context, couponId: context.read<BookRideProvider>().couponId.toString());
