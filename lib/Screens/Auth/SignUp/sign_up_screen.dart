                                ...
                                children: [
                                      ...
                                      child: Row(
                                        children: [
                                          CountryCodePicker(
                                            ...
                                            initialSelection: '+${context.read<AuthProvider>().countryCode}',
                                            favorite: const ['+354'],
                                          ...
                                          Expanded(
                                            child: TextFormFieldWidget(
                                              ...
                                              hintText: AppLocalizations.of(context)!
                                                  .phoneNumber,
                                              validator: (v)=> Validations.instance.phoneValidation(v!, context),
                                            ),
                                          ),
                                        ],
                                      )),
                                  ...
                                  ElevatedButtonWidget(
                                    onPressed: () {
                                      ...
                                      //       isSuccess: false);
                                      // } else {
                                      print("Country Code is ${context.read<AuthProvider>().countryCode}");
                                        if (formKey.currentState!.validate()) {
                                          ...
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                  builder: (builder) => const ContentScreen()));
                                        }
                                     // }
                                    },
