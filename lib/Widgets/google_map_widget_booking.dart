...
class GoogleMapWidgetBooking extends StatefulWidget {
  final double width;
  final double height;
  ...
  @override
  State<GoogleMapWidgetBooking> createState() => _GoogleMapWidgetBookingState();
}

class _GoogleMapWidgetBookingState extends State<GoogleMapWidgetBooking> {
